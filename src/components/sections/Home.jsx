...
import img from '../../assets/Santhosh.jpg'; // Ensure you have the correct path to your image
            ...
            <RevealOnScroll>
                <div className="flex flex-col items-center justify-center text-center z-10 px-4 space-y-6">
                    ...
                    <p className="text-gray-400 text-lg max-w-lg">
                        ...
                        Software Engineer
                        <br />
                        Final-year CSE student passionate about building scalable, user-friendly software and eager to contribute to impactful projects.
                    </p>
